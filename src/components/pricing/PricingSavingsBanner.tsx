...
export const PricingSavingsBanner: React.FC = () => {
  return (
    <div className="bg-[rgba(29,194,114,0.1)] flex w-full flex-col justify-center mt-[45px] px-px py-4 rounded-lg max-md:max-w-full max-md:mt-10">
      <div className="bg-[rgba(0,0,0,0)] flex items-center gap-6 flex-wrap px-[352px] py-0.5 max-md:max-w-full max-md:px-5">
        ...
        <div className="text-[rgba(29,194,114,1)] text-base font-medium text-center self-stretch w-[408px] my-auto">
